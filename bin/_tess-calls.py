...
Read-only. Needs Full Disk Access granted to cmux."""
import os, sys, sqlite3, datetime
sys.path.insert(0, os.path.dirname(os.path.abspath(__file__)))
from _tess_common import C, resolve, short  # noqa: E402
...
try:
    ...
    print("can't read call history — grant Full Disk Access to cmux:")
    print("  System Settings → Privacy & Security → Full Disk Access → enable cmux, then restart cmux.")
    sys.exit(1)
