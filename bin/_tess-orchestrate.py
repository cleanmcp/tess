...
from _tess_agents import AgentError, inject, launch

TESS_BIN = os.environ.get("TESS_BIN") or os.path.dirname(os.path.realpath(__file__))
MODE = os.path.join(os.path.dirname(TESS_BIN), "modes", "orchestrate.md")
...
def main():
    ...
    try:
        ...
        if not watch_running():
            subprocess.run(["python3", os.path.join(TESS_BIN, "_tess-watch.py"),
