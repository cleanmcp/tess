...
from tess_common import C, resolve, short, decode_body, chat_labels  # noqa: E402
...
try:
    ...
    print("can't read Messages — grant Full Disk Access to your terminal app, then restart it."); sys.exit(1)
