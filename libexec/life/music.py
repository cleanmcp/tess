...
def cmd_cover(args):
    ...
    if len(args) < 2:
        die('usage: tess music cover <playlist> <image.png|jpg>  (e.g. tess music cover "Late Nights" cover.png)')
...
if cmd in ("", "now"):
    ...
    if owned:
        ...
        # Music's own URL handler → native app, not the terminal's browser. Catalog tracks open the page (press play).
